...
function showDeveloperCredit() {
    const styles = [
        'background: linear-gradient(135deg, #1E90FF, #00FFFF)', // DodgerBlue to Cyan gradient
        'color: white',
        'padding: 20px 30px',
        ...
        'border-radius: 15px',
        // A multi-layered shadow: a hard black shadow for definition and a cyan glow for effect.
        'text-shadow: 2px 2px 0px #000000, 0 0 1.5em #1E90FF, 0 0 0.3em #1E90FF'
    ].join(';');

    console.log('%c NewDev Maroc ', styles);
}

// Call the function to display the log message.
showDeveloperCredit();
